	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-md-offset-2 col-md-9">
				<span style="font-size: larger; text-align: left">为用户"${user.name}" 分配角色：</span><br/>

				<sf:form id="userForm" action="" method="post" modelAttribute="form"
					...
					<table id="simple-table" class="table table-striped table-bordered table-hover center"
						...
						<tbody>
						<c:forEach var="item" items="${allRoleList}">
							<tr>
								<td>
									<sf:checkbox path="roleIdArray" value="${item.id}"/>
								</td>
...
<script type="text/javascript">
	...
	$("#commitBtn").click(function () {
		var path = "${base}/auth/user/authorize";
